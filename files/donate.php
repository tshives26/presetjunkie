...
$page_title = __(
  "Thanks for buying me a beer! Click to copy the crypto address.",
  "cftp_admin"
);
        ...
        <div class="mt-24">
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        ...
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/1.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/1027.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/328.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center" id="shiba_inu"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/5994.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/74.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/1934.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/2010.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/512.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/4030.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/3635.png"
                    />
            ...
            <a rel="noopener nofollow" class="page-item-each py-10 flex-both-center"
                ...
                data-id="262545" data-type="page_item">
                    <img
                        class="link-each-image"
                        data-src="https://s2.coinmarketcap.com/static/img/coins/64x64/18876.png"
                    />
...
<script >
// function outFunc() {
//     let tooltip = document.getElementById('donate-mera-tool-tip');
...
$('#bitcoin').click(function (e) {
 ...
 $('#ethereum').click(function (e) {
   ...
   document.execCommand('copy');
   $("#ethereum-tool-tip").html("Copied!");
   $("#ethereum-tool-tip").show();
   setTimeout(function(){ $("#ethereum-tool-tip").hide() }, 2000);
 });
 $('#monero').click(function (e) {
   e.preventDefault();
   var copyText = $(this).attr('href');
 ...
 $('#shiba_inu').click(function (e) {
   ...
   document.execCommand('copy');
   $("#shiba_inu-tool-tip").html("Copied!");
   $("#shiba_inu-tool-tip").show();
   setTimeout(function(){ $("#shiba_inu-tool-tip").hide() }, 2000);
 });
 $('#dogecoin').click(function (e) {
   e.preventDefault();
   var copyText = $(this).attr('href');
   ...
   document.execCommand('copy');
   $("#dogecoin-tool-tip").html("Copied!");
   $("#dogecoin-tool-tip").show();
   setTimeout(function(){ $("#dogecoin-tool-tip").hide() }, 2000);
 });
 $('#loopring').click(function (e) {
   e.preventDefault();
   var copyText = $(this).attr('href');
   ...
   document.execCommand('copy');
   $("#loopring-tool-tip").html("Copied!");
   $("#loopring-tool-tip").show();
   setTimeout(function(){ $("#loopring-tool-tip").hide() }, 2000);
 });
 $('#cardano').click(function (e) {
   e.preventDefault();
   var copyText = $(this).attr('href');
 ...
 $('#stellar').click(function (e) {
   ...
   document.execCommand('copy');
   $("#stellar-tool-tip").html("Copied!");
   $("#stellar-tool-tip").show();
   setTimeout(function(){ $("#stellar-tool-tip").hide() }, 2000);
 });
 $('#algorand').click(function (e) {
   e.preventDefault();
   var copyText = $(this).attr('href');
   ...
   document.execCommand('copy');
   $("#algorand-tool-tip").html("Copied!");
   $("#algorand-tool-tip").show();
   setTimeout(function(){ $("#algorand-tool-tip").hide() }, 2000);
 });
 $('#cronos').click(function (e) {
   e.preventDefault();
   var copyText = $(this).attr('href');
   ...
   document.execCommand('copy');
   $("#cronos-tool-tip").html("Copied!");
   $("#cronos-tool-tip").show();
   setTimeout(function(){ $("#cronos-tool-tip").hide() }, 2000);
 }); $('#apeCoin').click(function (e) {
   e.preventDefault();
   var copyText = $(this).attr('href');
   ...
   document.execCommand('copy');
   $("#apeCoin-tool-tip").html("Copied!");
   $("#apeCoin-tool-tip").show();
   setTimeout(function(){ $("#apeCoin-tool-tip").hide() }, 2000);
 });
</script>
<script>
